    ...
    class(CAMBdata) :: this
    real(dl), intent(in) :: a
    real(dl) :: dtauda, grhoa2, grhov_de,grhov_t,w!,grhorr,Meff,rhonu,omegar,omegam

    call this%CP%DarkEnergy%BackgroundDensityAndPressure(this%grhov, a, grhov_t,w,this%CP%M,this%CP%N,this%grho_no_de(a),this%grhocrit)
    ...
    real(dl) dgrho_de, dgq_de, cs2_de,omegar,omegam
...
!     w_dark_energy_t = -1_dl
     call State%CP%DarkEnergy%BackgroundDensityAndPressure(State%grhov, a, grhov_t, w_dark_energy_t,State%CP%M,State%CP%N,State%grho_no_de(a),State%grhocrit)
...
!     !total perturbations: matter terms first, then add massive nu, de and radiation
    ...
    real(dl) pir,adotoa
    real(dl) w_dark_energy_t,omegam,omegar
    ...
    grhor_t=State%grhornomass/a2
    grhog_t=State%grhog/a2
    omegar=(State%grhog+State%grhornomass)/State%grhocrit
    omegam=(State%CP%omch2 + State%CP%ombh2 + State%CP%omnuh2)/(State%CP%H0/100)**2


    call CP%DarkEnergy%BackgroundDensityAndPressure(State%grhov, a, grhov_t, w_dark_energy_t,State%CP%M,State%CP%N,State%grho_no_de(a),State%grhocrit)
