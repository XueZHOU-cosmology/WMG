    ...
    use constants, only : barssc0, Compton_CT, line21_const,c
    use MassiveNu
    use Recombination
    implicit none
    type(EvolutionVars) EV
    ...
    real(dl) dgrho_de, dgq_de, cs2_de,omegar,omegam,EE,gpres_DE
...
!         gpres = gpres_noDE + w_dark_energy_t*grhov_t
    ...
    real(dl) pir,adotoa
    real(dl) w_dark_energy_t,EE,gpres_noDE, grho_matter,gpres_DE
