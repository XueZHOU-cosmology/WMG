...
10      if (this%CP%Omnuh2 < 1.e-7_dl) this%CP%Omnuh2 = 0
    ...
    real(dl) :: grhov_t, rhonu, grhonu, a,omegar,omegam,w
    ...
    function gpre_no_de(this, a) result(gpre_no_de_t)
    !  Return 8*pi*G*pre_no_de*a**4 where pre_no_de includes everything except dark energy.
    class(CAMBdata) :: this
    real(dl), intent(in) :: a
    real(dl)  rhonu, grhormass_t, gpnu_t,gpre_no_de_t,gpres_nu,pnu
    integer nu_i

    do nu_i = 1, this%CP%nu_mass_eigenstates
        grhormass_t=this%grhormass(nu_i)
    ...
    gpre_no_de_t = gpres_nu  + (this%grhog + this%grhornomass)/3._dl

    end function gpre_no_de
